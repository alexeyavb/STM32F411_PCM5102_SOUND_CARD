...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : SPI PBPin PBPin PBPin PBPin */
  ...
  // Set mute on
  HAL_GPIO_WritePin(I2S2_MUTE_CTRL_GPIO_Port, I2S2_MUTE_CTRL_Pin, GPIO_PIN_RESET);
}
