...
/* Configure the peripherals common clocks */
  ...
  extern void audio_v1_init(uint8_t busid, uint32_t reg_base);
  ...
  audio_v1_init(0, USB_OTG_FS_PERIPH_BASE);
  /* USER CODE END 2 */
  /* Infinite loop */
  ...
  {
    /* USER CODE END WHILE */      
      usbd_audio_open(0,(uint8_t)0x00U);
      audio_test(0);
      HAL_Delay(500);
      usbd_audio_close(0, (uint8_t)0x00U);
    /* USER CODE BEGIN 3 */
  }
  UNUSED(ep_tx_busy_flag);
  /* USER CODE END 3 */
}
